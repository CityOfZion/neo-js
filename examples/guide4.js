...
async function main () {
  ...
  const neoBlockchain = new Neo('testnet', { mode: 'full', diagnosticInterval: 1000, verboseLevel: 3 }) // The blockchain instance will be disgnosing a node every 1000ms.
  
  console.log('getBlock:', await neoBlockchain.getBlock(1000))
